...
static struct platform_device *smdkv210_devices[] __initdata = {
	...
	&s3c_device_nand,		/* add by zjh */
	&s3c_device_timer[1],	/* add by zjh */
	&tq210_beeper,			/* add by zjh */
	&tq210_leds,			/* add by zjh */
	&tq210_keys,			/* add by zjh */
	&ds18b20_device,		/* add by zjh */
	&s5p_device_ehci,		/* add by zjh */
};
...
static struct i2c_board_info smdkv210_i2c_devs0[] __initdata = {
	{ I2C_BOARD_INFO("24c02", 0x50), },		/* add by zjh */
};
